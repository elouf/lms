...
{
    public function getDistantParameters (Request $request)
    {
        $serveur = $this->getParameter('distant_host');
        $database = $this->getParameter('distant_host');
        $user = $this->getParameter('distant_host');
        $password = $this->getParameter('distant_host');
        return [$serveur, $database, $user, $password];
    }
